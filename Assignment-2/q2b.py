...
def distance_from_corners(sheep_x,sheep_y):

    result=0

    result=result+distance(sheep_x,sheep_y,0,0)
    result=result+(10*distance(sheep_x,sheep_y,0,7))
    result=result+(100*distance(sheep_x,sheep_y,7,0))
    result=result+(1000*distance(sheep_x,sheep_y,7,7))

    return result
    

def sheep_next(sheep_,new_sheep_):
    
    if(new_sheep_-sheep_>0):
        return 1
    else:
        return -1

def sheep_step_size(sheep_,new_sheep_):
    return(abs(new_sheep_-sheep_))
...
def main():
    ...
    for i in tqdm(range(0,10000)):
        ...
        for i in range(0,100):
            ...
            if(distance(caveman1_x,caveman1_y,sheep_x,sheep_y)==1 or distance(caveman2_x,caveman2_y,sheep_x,sheep_y)==1):
                ...
                x_state=(sheep_x,caveman1_x,caveman2_x)
                y_state=(sheep_y,caveman1_y,caveman2_y)
                distance_from_corners_=distance_from_corners(sheep_x,sheep_y)
                distance_from_caveman_1=distance(sheep_x,sheep_y,caveman1_x,caveman1_y)
                distance_from_caveman_2=distance(sheep_x,sheep_y,caveman2_x,caveman2_y)
                
                step_state=(distance_from_corners_,sheep_x,sheep_y,distance_from_caveman_1,distance_from_caveman_2)
                sheep_movement_in_x[x_state]=sheep_next(sheep_x,new_sheep_x)
                sheep_movement_in_y[y_state]=sheep_next(sheep_y,new_sheep_y)
                sheep_movement_step_size[step_state]=sheep_step_size(sheep_x,new_sheep_x)
                movement_step_size=sheep_step_size(sheep_x,new_sheep_x)
                caveman_choice_state=(sheep_x,sheep_y,caveman1_x,caveman1_y,caveman2_x,caveman2_y,movement_step_size,new_sheep_x,new_sheep_y)
                caveman_1_choice[caveman_choice_state]=[new_caveman1_x,new_caveman1_y]
    ...
    # print("Caveman Captured Sheep : ",caveman)
    # print("Caveman couldn't captured sheep : ",sheep)
    sheep=0
    caveman=0
    print('Testing')
    for i in tqdm(range(0,200)):
        ...
        # print("Iterations : ",i+1)
        # print("Caveman couldn't captured sheep")
    print("Caveman Captured Sheep(%) : ",(caveman/(caveman+sheep))*100)
    print("Caveman couldn't captured sheep(%) : ",(sheep/(caveman+sheep))*100)
